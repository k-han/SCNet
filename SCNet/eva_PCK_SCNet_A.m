...
%imdbPath = fullfile('../data', 'PF-PASCAL-RP-500.mat');
...
for i = 1:numel(val_idx)
    ...
    %proposals = [proposals_A; proposals_B];
    if exist(['flow/A1000_2/' num2str(i) '.mat'])==0
        ...
        save(['flow/A1000_2/' num2str(i) '.mat'],'vx','vy')
    else
        load(['flow/A1000_2/' num2str(i) '.mat'],'vx','vy')
    end
...
if visulize
    ...
    legend('SCNet-A','Location','northwest');
