function [net, info] = SCNet_AGplus(varargin)
%SCNet_AGplus: train and eva SCNet_AGplus
...
opts.train = struct() ;
opts.train.gpus = [];
opts.train.expDir = fullfile('data',['exp_SCNet_AGplus_' dataset]) ; %folder to save trained nets
