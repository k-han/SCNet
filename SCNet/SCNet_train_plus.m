function [net,stats] = SCNet_train_plus(net, imdb, getBatch, varargin)
...
if isempty(opts.train)
    opts.train = find(imdb.data.set==1); 
end
...
%       figure(102) ; clf ; vl_imarraysc(inputs{2}) ; colormap jet ; drawnow;
      net.eval(inputs, opts.derOutputs) ;
    else
      net.mode = 'test' ;
%       figure(103) ; clf ; vl_imarraysc(inputs{2}) ; colormap jet ; drawnow;
      net.eval(inputs) ;
    end
  end
