function [candidates, scores] = US(im, num_samples_selected, truncate)
if nargin < 4
    truncate = true;
end

num_samples=4*num_samples_selected;

load('object-proposal/baselines/pascal_voc07_random_sampling_params.mat');
